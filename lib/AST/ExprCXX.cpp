...
ReflexprExpr::getMetaobjectKindName(MetaobjectKind MoK) {
  switch(MoK) {
    case MOK_Specifier:          return "a specifier";
    case MOK_Inheritance:        return "an inheritance";
    case MOK_GlobalScope:        return "the global scope";
    case MOK_Namespace:          return "a namespace";
    case MOK_NamespaceAlias:     return "a namespace alias";
    case MOK_Type:               return "a type";
    case MOK_Enum:               return "an enum";
    case MOK_Record:             return "a record";
    case MOK_Class:              return "a class";
    case MOK_NamedFunction:      return "a function";
    case MOK_TypeAlias:          return "a type alias";
    case MOK_EnumAlias:          return "a enum alias";
    case MOK_RecordAlias:        return "a record alias";
    case MOK_ClassAlias:         return "a class alias";
    case MOK_TplTypeParam:       return "a template type parameter";
    case MOK_Variable:           return "a variable";
    case MOK_DataMember:         return "a data member";
    case MOK_MemberType:         return "a member type";
    case MOK_MemberTypeAlias:    return "a member type alias";
    case MOK_MemberRecord:       return "a member record";
    case MOK_MemberRecordAlias:  return "a member record alias";
    case MOK_MemberClass:        return "a member class";
    case MOK_MemberClassAlias:   return "a member class alias";
    case MOK_MemberEnum:         return "a member enum";
    case MOK_MemberEnumAlias:    return "a member enum alias";
    case MOK_MemberFunction:     return "a member function";
    case MOK_Enumerator:         return "a enumerator";
    case MOK_ObjectSequence:     return "a metaobject sequence";
...
translateMetaobjectKindToMetaobjectConcept(MetaobjectKind MoK) {
  switch(MoK) {
    ...
    case MOK_NamedFunction:      return MOC_NamedFunction;
    case MOK_DataMember:         return MOC_DataMember;
    case MOK_MemberType:         return MOC_MemberType;
    case MOK_MemberTypeAlias:    return MOC_MemberTypeAlias;
    case MOK_MemberRecord:       return MOC_MemberRecord;
    case MOK_MemberRecordAlias:  return MOC_MemberRecordAlias;
    case MOK_MemberClass:        return MOC_MemberClass;
    case MOK_MemberClassAlias:   return MOC_MemberClassAlias;
    case MOK_MemberEnum:         return MOC_MemberEnum;
    case MOK_MemberEnumAlias:    return MOC_MemberEnumAlias;
    case MOK_MemberFunction:     return MOC_MemberFunction;
...
QualType
ReflexprExpr::getBaseArgumentType(ASTContext&, bool removeSugar) const {
...
const ValueDecl*
ReflexprExpr::findArgumentValueDecl(ASTContext& Ctx) const {
...
std::size_t
UnaryMetaobjectOpExpr::opSourceFileLen(ASTContext& Ctx, uintptr_t moid) {
...
std::size_t
UnaryMetaobjectOpExpr::opBaseNameLen(ASTContext& Ctx, uintptr_t moid) {
...
std::size_t
UnaryMetaobjectOpExpr::opDisplayNameLen(ASTContext& Ctx, uintptr_t moid) {
...
ReflexprExpr*
UnaryMetaobjectOpExpr::opHideProtected(ASTContext& Ctx, uintptr_t moid) {
  return ReflexprExpr::getHideProtectedReflexprExpr(Ctx, asReflexpr(Ctx, moid));
}

ReflexprExpr*
UnaryMetaobjectOpExpr::opHidePrivate(ASTContext& Ctx, uintptr_t moid) {
...
const ValueDecl*
UnaryMetaobjectOpExpr::getValueDeclResult(ASTContext& Ctx,
                                          UnaryMetaobjectOp MoOp,
                                          uintptr_t moid) {
...
QualType
UnaryMetaobjectOpExpr::getValueDeclType(ASTContext& Ctx,
                                        UnaryMetaobjectOp MoOp,
...
QualType
UnaryMetaobjectOpExpr::getOpResultType(ASTContext& Context) const {
  ...
  switch (MoOp) {
    ...
    case UMOO_GetConstant:
    case UMOO_GetPointer: {
      const auto *VD = getValueDeclResult(Context, MoOp, getArgumentExpr());
